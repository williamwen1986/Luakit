 ...
 */
static CURLcode easy_perform(CURL *d, bool events)
{
  struct Curl_easy *data = (struct Curl_easy *)d;
 ...
 * transfer as previously setup.
 */
CURLcode curl_easy_perform(CURL *d)
{
  struct Curl_easy *data = (struct Curl_easy *)d;
 ...
 */
CURLcode curl_easy_perform_ev(CURL *d)
{
  struct Curl_easy *data = (struct Curl_easy *)d;
...
CURLcode curl_easy_getinfo(CURL *d, CURLINFO info, ...)
{
  struct Curl_easy *data = (struct Curl_easy *)d;
  va_list arg;
  void *paramp;
...
static CURLcode easy_connection(CURL *d,
                                curl_socket_t *sfd,
 ...
 */
CURLcode curl_easy_recv(CURL *d, void *buffer, size_t buflen,
                        size_t *n)
{
  struct Curl_easy *data = (struct Curl_easy *)d;
  curl_socket_t sfd;
 ...
 * curl_easy_perform() with CURLOPT_CONNECT_ONLY option.
 */
CURLcode curl_easy_send(CURL *d, const void *buffer,
