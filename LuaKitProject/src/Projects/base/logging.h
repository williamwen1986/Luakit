...
BASE_EXPORT void SetIsAndroidLogOn(bool is_on);
    
BASE_EXPORT bool GetIsAndroidLogOn();
    
BASE_EXPORT void SetIsLogEncript(bool is_encript);
    
BASE_EXPORT bool GetIsLogEncript();
...
class BASE_EXPORT LogMessage {
 public:
  ...
  static std::string EncrptData(const std::string* str);
    
 private:
  void Init(const char* file, int line);
  void WriteFile(const char* data);
  void WriteFileEncrpte(const std::string* data);
  static void intToBytes(int n , unsigned char bytes[4]);
