...
JNI_EXPORT void JNICALL Java_com_common_luakit_LuaHelper_setDataDirectoryPath__Ljava_lang_String_2 (JNIEnv *env, jclass c, jstring thePath )
{
    const char* path = env ->GetStringUTFChars((jstring)thePath, NULL);
    luaSetDataDirectoryPath((std::string)path);
...
JNI_EXPORT void JNICALL Java_com_common_luakit_LuaHelper_setCacheDirectoryPath__Ljava_lang_String_2 (JNIEnv *env, jclass c, jstring thePath )
{
    const char* path = env ->GetStringUTFChars((jstring)thePath, NULL);
    luaSetCacheDirectoryPath((std::string)path);
    env ->ReleaseStringUTFChars((jstring)thePath, path);
}

JNI_EXPORT void JNICALL Java_com_common_luakit_LuaHelper_setDownloadDirectoryPath__Ljava_lang_String_2 (JNIEnv *env, jclass c, jstring thePath )
{
    const char* path = env ->GetStringUTFChars((jstring)thePath, NULL);
    luaSetDownloadDirectoryPath((std::string)path);
    env ->ReleaseStringUTFChars((jstring)thePath, path);
}

JNI_EXPORT void JNICALL Java_com_common_luakit_LuaHelper_setNativeLibraryDirectoryPath__Ljava_lang_String_2 (JNIEnv *env, jclass c, jstring thePath )
{
    const char* path = env ->GetStringUTFChars((jstring)thePath, NULL);
    luaSetNativeLibraryDirectoryPath((std::string)path);
    env ->ReleaseStringUTFChars((jstring)thePath, path);
}

JNI_EXPORT void JNICALL Java_com_common_luakit_LuaHelper_setExternalStorageDirectoryPath__Ljava_lang_String_2 (JNIEnv *env, jclass c, jstring thePath )
{
    const char* path = env ->GetStringUTFChars((jstring)thePath, NULL);
