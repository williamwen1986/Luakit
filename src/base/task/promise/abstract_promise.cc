...
BasePromise::BasePromise(BasePromise&& other) noexcept = default; // Patch [LARPOUX]

BasePromise& BasePromise::operator=(const BasePromise& other) = default;
BasePromise& BasePromise::operator=(BasePromise&& other) noexcept = default; // Patch [LARPOUX]
...
WrappedPromise::WrappedPromise(WrappedPromise&& other) noexcept = default; // Patch [LARPOUX]

WrappedPromise& WrappedPromise::operator=(const WrappedPromise& other) =
    default;
WrappedPromise& WrappedPromise::operator=(WrappedPromise&& other) noexcept = default; // Patch [LARPOUX]
