...
CURLMcode curl_multi_add_handle(CURLM *m,
                                CURL *d)
{
  struct Curl_easy *data = (struct Curl_easy *)d;
  struct Curl_multi *multi = (struct Curl_multi *)m;
...
CURLMcode curl_multi_remove_handle(CURLM *m,
                                   CURL *d)
{
  struct Curl_easy *data = (struct Curl_easy *)d;
  struct Curl_multi *multi = (struct Curl_multi *)m;
...
CURLMcode curl_multi_socket(CURLM *m, curl_socket_t s,
                            int *running_handles)
{
  struct Curl_multi *multi = (struct Curl_multi *)m;
  CURLMcode result;
